...
def hitung():
    ...
    hasil_label.config(text=f"Total Harga: {total:.2f} Rupiah")  # Menambahkan label total harga
...
hitung_button = ttk.Button(window, text="Hitung Total", command=hitung)  # Mengganti hitung_button menjadi window
hitung_button.pack()
